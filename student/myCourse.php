    ...
    <div class="row">
        <div class="jumbotron">
            ...
            if(isset($stuLogEmail)){
                ...
                c.course_img,c.course_author,c.course_original_price,c.course_price FROM courseorder
                AS co JOIN course AS c ON c.course_id = co.course_id WHERE co.stu_email = '$stuLogEmail'";
                     ...
                     <div class="row">
                      ...
                      <div class="col-sm-6 mb-3">
                        <div class="card-body">
                         ...
                         <a href="watchcourse.php?course_id=<?php echo $row['course_id'] ?>" class="btn btn-info mt-5 float-right">Watch Course</a>
                        </div>
                      </div>
                     </div>
                     </div>
