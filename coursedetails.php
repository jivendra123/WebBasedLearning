...
<div class="container-fluid bg-dark">
 <div class="row">
 <img src="./image/header-img.png"  alt="course"
...
<?php 
  if(isset($_GET['course_id'])){
      ...
      $_SESSION['course_price'] = $course_id;
...
?>
    <div class="row">
        <div class="col-md-4">
            <img src="<?php echo str_replace('..','.',$row['course_img']) ?>" class="card-img-top" alt="C++">
        </div>
        <div class="col-md-8">
            <div class="card-body">
                ...
                <form action="checkout.php" method="post">
                    ...
                    <button type="submit" class="btn btn-info tex-white font-weight-bolder float-right" name="buy">
                        Buy Now
                    </button>
                </form>  
            </div>
