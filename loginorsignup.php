  ...
  <div class="col-md-4">
   ...
   <form role="form" id="stuLoginForm">
    <div class="form-group">
     ...
     class="pl-2 font-weight-bold">Email</label><small id="statusLogMsg1"></small>
    ...
    <button type="button" class="btn btn-info" id="stuLoginBtn" onclick="checkStuLogin()">Login</button>
   </form><br/>
  ...
  <div class="col-md-6 offset-md-1">
   ...
   <form role="form" id="stuRegForm">
    ...
    <div class="form-group">
     ...
     <small calss="form-text">we'll never share your email with anyone else.</small>
    </div>
    <div class="form-group">
     <i class="fas fa-key"></i><label for="stupass"
     class="pl-2 font-weight-bold">New Password</label>
     <input type="password" class="form-control" placeholder="Password" name="stupass" id="stupass">
    </div>
    <button type="button" class="btn btn-info" id="signup" onclick="addStu()">Sign Up</button>
   </form><br/>
